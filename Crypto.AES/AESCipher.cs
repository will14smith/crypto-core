...
namespace Crypto.AES
{
    public class AESCipher : IBlockCipher
    {
        ...
        {
            var keyParams = parameters as AESKeyParameter;
        ...
        {
            SecurityAssert.Assert(round * 16 + 16 <= _roundKeys.Length);
        ...
        private static readonly byte[] G11 =
        {
        ...
        private static readonly byte[] G13 =
        {
        ...
        private static readonly byte[] G14 =
        {
        ...
        private static readonly byte[] G3 =
        {
        ...
        private static readonly byte[] G9 =
        {
