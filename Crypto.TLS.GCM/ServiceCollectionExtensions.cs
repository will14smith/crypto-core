...
namespace Crypto.TLS.GCM
{
    public static class ServiceCollectionExtensions
    {
        ...
        {
            services.RegisterCipherAlgorithm(GCMIdentifiers.AES128_GCM, () => new AEADCipherAdapter(new GCMCipher(new AESCipher(128))));
            services.RegisterCipherAlgorithm(GCMIdentifiers.AES256_GCM, () => new AEADCipherAdapter(new GCMCipher(new AESCipher(256))));
